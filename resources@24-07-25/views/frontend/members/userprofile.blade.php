          ...
          <div>
            ...
            <form method="POST" action="{{ route('updateprofile', ['id' => auth()->user()->id]) }}"
              ...
              <div class="row g-3">
                ...
                <div class="col-md-12">
                  <label class="form-label">Laboratory or office in Building 46 are you associated with?</label>
                  <input type="text" class="form-control" name="laboratory_name" value="{{ auth()->user()->laboratory_name }}" />
                </div>
            ...
            <br>
            <img src="{{ asset('/admin/assets/images/' . auth()->user()->image) }}" alt="Current Image"
