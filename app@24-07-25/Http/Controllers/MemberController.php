...
public function checkActiveSlots()
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $emailData = [
                ...
                'agenda' => $validated['agenda'],
                'description' => $validated['description'],
                'other_details' => $validated['other_details'] ?? 'N/A',
            ];
    ...
    public function cancelBookingById($id, $slot_id)
    {
        ...
        if ($bookingHistory) {
            ...
            return redirect()->route('user.bookingHistorylist')->with('success', 'Booking canceled successfully.');
        } else {
            return redirect()->route('user.bookingHistorylist')->withErrors(['error' => 'Booking not found.']);
        }
    }
