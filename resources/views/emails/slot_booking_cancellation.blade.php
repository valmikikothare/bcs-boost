...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4;">
    <table width="100%" cellpadding="0" cellspacing="0">
        <!-- Header -->
        <tr>
            <td align="center" bgcolor="#b91c1c" style="padding: 20px;">
                    ...
                    <tr>
                        <td>
                            ...
                            <p style="font-size: 16px; margin: 0 0 20px 0;">
                                We confirm the cancellation of your booking for the session below:
                            </p>

                            <!-- Session Details Table -->
                            <table cellpadding="10" cellspacing="0" width="100%" style="border-collapse: collapse; background: #fafafa; border-radius: 6px;">
                                <tr>
                                    <td style="border-bottom: 1px solid #ddd; font-weight: bold; width: 40%;">Session Name:</td>
                                ...
                                <tr>
                                    ...
                                    <td style="border-bottom: 1px solid #ddd;">{{ $slot->start_time }} – {{ $slot->end_time }}</td>
                                </tr>
                                <tr>
                                    <td style="font-weight: bold;">Short Description:</td>
                                    <td>{{ ucfirst(optional($slot->sessionLeads->first())->agenda ?? 'N/A') }}</td>
                                </tr>
                            </table>

                            <!-- Call to Action -->
                            <p style="font-size: 16px; margin: 25px 0 10px 0; text-align: center;">
                                If this cancellation was a mistake, you can rebook anytime from your dashboard.
                            </p>

                            <div style="text-align: center; margin: 20px 0;">
                                <a href="{{ url('/dashboard') }}" target="_blank"
                                    style="background: #2563eb; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 14px; display: inline-block;">
                                    Rebook from Dashboard
                                </a>
                            </div>

                            <p style="font-size: 14px; color: #555; margin: 0; text-align: center;">
                                For more details and updates, please visit the
        ...
        <tr>
            <td align="center" bgcolor="#222" style="color: #bbb; padding: 15px; font-size: 12px;">
                &copy; {{ date('Y') }} Boost Team. All rights reserved.
            </td>
        </tr>
    </table>
</body>
