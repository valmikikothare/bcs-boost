                                        ...
                                        <div class="bg-white py-4 px-4 shadow">
                                            <div class="card-body d-flex flex-column">
                                                ...
                                                <p class="card-text" style="font-size: 14px;">
                                                    <span class="text-dark h6"><i class="fa-solid fa-clock me-1"></i>Timing
                                                        : </span>
                                                    {{ $slot->start_time }} -
                                                    {{ $slot->end_time }}
                                                </p>
                                                ...
                                                <div class="pt-3">
                                                    ...
                                                    @elseif($slot->sessionLeads->status == 1)
                                                        <button class="btn btn-success w-100 px-0 mx-0"
                                                            disabled>Approved</button>
                                                    @elseif($slot->sessionLeads->status == 2)
                                                        <button class="btn btn-danger w-100 px-0 mx-0"
