        ...
        <div class="container-fluid">
            ...
            <div class="bg-white shadow mt-4 overflow-hidden">
                ...
                <div class="px-4 py-4">
                    ...
                    <!-- Export All Sessions -->
                    <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                        <h5 class="mb-0">Export All Sessions</h5>
                        <a href="{{ route('sessions.export.csv') }}" class="btn btn-success">Export Sessions CSV</a>
                    </div>
                                    ...
                                    <form action="{{ route('system.reset') }}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox" name="export_sessions"
                                                    id="exportSessions">
                                                <label class="form-check-label" for="exportSessions">
                                                    I have confirmed the export of all session data.
                                                </label>
                                            </div>
