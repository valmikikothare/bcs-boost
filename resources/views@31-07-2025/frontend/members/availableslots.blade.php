                    ...
                    <div class="col-md-9 bg-white shadow p-4">
                        ...
                        {{-- <p class="mb-1" style="font-size: 14px;">
                                                <span class="text-dark h6"><i
                                                        class="fa-solid fa-info-circle me-2"></i>Status: </span>
                                                @php
                                                ...
                                                <span
                                                    class="badge 
                            @if ($slot->status == 0) bg-warning text-dark 
                            @elseif ($slot->status == 1) bg-success 
                            @elseif ($slot->status == 2) bg-primary 
                            @else bg-secondary @endif">
                                            ...
                                            <p class="card-text py-3" style="font-size: 14px;">
                                                <span class="text-dark h6"><i
                                                        class="fa-solid fa-calendar-days me-2"></i>Date:
                                                </span>
                                                {{ \Carbon\Carbon::createFromFormat('m-d-Y', $slot->date)->format('F j, Y') }}
                                            </p>
                                            <p class="card-text" style="font-size: 14px;">
                                                <span class="text-dark h6"><i class="fa-solid fa-clock me-2"></i>Timing:
                                                </span>
                                                {{ $slot->start_time }} -
                                                {{ $slot->end_time }}
                                            </p>
