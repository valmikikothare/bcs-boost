                                ...
                                <tr id="slotRow_{{ $slot->id }}">
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-sm" data-toggle="modal"
                                            data-target="#editSlotModal" onclick="editSlot({
                                                                        id: {{ $slot->id }},
                                                                        name: '{{ $slot->name }}',
                                                                        date: '{{ $slot->date }}',
                                        ...
                                        <a href="{{ route('slots.markas_complete', $slot->sessionLeads->id) }}"
                                            class="btn btn-info btn-sm mt-2">Mark as Complete</a>
                                            @endif
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Slot #1" class="form-control" id="name" name="name"
                                    required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" id="edit_date" name="date" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control timepicker" id="edit_end_time" name="end_time"
                                    required>
                            </div>
                ...
                $.ajax({
                    ...
                    success: function (resultData) {
                        ...
                        if (resultData.success) {
                            ...
                            $('#slotRow_' + id).remove(); // Adjust the row ID based on your HTML structure
                        }
                    },
